import { View, Text, FlatList, StyleSheet, Image, Alert, SafeAreaView, TouchableWithoutFeedback, TouchableOpacity, Platform, ActivityIndicator, ScrollView } from 'react-native';
...
import { ChevronDownIcon, EllipsisIcon, FeatherPenIcon, PersonIcon, PlusIcon, PrettyLoadingIcon, ThumbsUpIcon, TrashIcon, TranslateIcon, BlockIcon, FlagIcon, SmileIcon } from '../../utils/Svgs';
...
const styles = StyleSheet.create({
  ...
  emojiUserItem: {
    ...
    paddingVertical: 6,
    borderBottomWidth: 1,
    borderBottomColor: Colors.primaryLightGray + '80',
  },
  emojiUserInfo: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Add styles for selected emoji and note
